...
# claudine/
APPS_DIR = BASE_DIR / "claudine"
env = environ.Env()
APP_NAME = env.str("APP_NAME", default="claudine")
...
MIGRATION_MODULES = {"sites": "claudine.contrib.sites.migrations"}
...
ACCOUNT_FORMS = {"signup": "claudine.users.forms.UserSignupForm"}
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_ADAPTER = "claudine.users.adapters.SocialAccountAdapter"
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_FORMS = {"signup": "claudine.users.forms.UserSocialSignupForm"}
